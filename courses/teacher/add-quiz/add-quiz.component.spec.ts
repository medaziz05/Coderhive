...
import { IAnswer } from '@app/courses/models/answer.model';
import { of, throwError } from 'rxjs';
import { HttpResponse } from '@angular/common/http';
import { IQuizFull } from '@app/courses/models/quiz-full.model';
import { ToastrService } from 'ngx-toastr';
import { QuizService } from '@app/courses/services/quiz.service';
import { FormsModule } from '@angular/forms';
import { IQuestion } from '@app/courses/models/question.model';
...
describe('CreateComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [AddQuizComponent, FormsModule],
      providers: [
